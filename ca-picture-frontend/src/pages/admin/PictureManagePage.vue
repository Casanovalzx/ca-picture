  ...
  <div id="pictureManagePage">
    <a-flex justify="space-between">
      ...
      <a-space>
        ...
        <a-button type="primary" @click="$router.push('/add_picture/batch')">
          + 批量创建图片
        </a-button>
        <!-- 新增批量编辑按钮 -->
        <a-button
        ...
        <template v-else-if="column.key === 'action'">
          <a-space wrap>
            ...
            <a-button
              type="primary"
              ghost
              @click.prevent="$router.push(`/add_picture?id=${record.id}`)"
            >
              编辑
            </a-button>
            <a-popconfirm
...
const selectedPictures = computed(() =>
  dataList.value.filter((picture) => selectedRowKeys.value.includes(picture.id)),
)
